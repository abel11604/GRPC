...
public final class CarParkServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.sample.park.CarParkService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<org.sample.park.ParkRequest,
      org.sample.park.ParkResponse> METHOD_PARK_VEHICLE =
      io.grpc.MethodDescriptor.<org.sample.park.ParkRequest, org.sample.park.ParkResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "org.sample.park.CarParkService", "parkVehicle"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.sample.park.ParkRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.sample.park.ParkResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<org.sample.park.ParkRequest,
      org.sample.park.ParkResponseManyTimes> METHOD_PARK_VEHICLE_MANY_TIMES =
      io.grpc.MethodDescriptor.<org.sample.park.ParkRequest, org.sample.park.ParkResponseManyTimes>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "org.sample.park.CarParkService", "parkVehicleManyTimes"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.sample.park.ParkRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.sample.park.ParkResponseManyTimes.getDefaultInstance()))
          .build();
  ...
  public static abstract class CarParkServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void parkVehicle(org.sample.park.ParkRequest request,
        io.grpc.stub.StreamObserver<org.sample.park.ParkResponse> responseObserver) {
     ...
     * </pre>
     */
    public void parkVehicleManyTimes(org.sample.park.ParkRequest request,
        io.grpc.stub.StreamObserver<org.sample.park.ParkResponseManyTimes> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.sample.park.ParkRequest,
                org.sample.park.ParkResponse>(
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                org.sample.park.ParkRequest,
                org.sample.park.ParkResponseManyTimes>(
  ...
  public static final class CarParkServiceBlockingStub extends io.grpc.stub.AbstractStub<CarParkServiceBlockingStub> {
     ...
     * </pre>
     */
    public org.sample.park.ParkResponse parkVehicle(org.sample.park.ParkRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<org.sample.park.ParkResponseManyTimes> parkVehicleManyTimes(
        org.sample.park.ParkRequest request) {
  ...
  public static final class CarParkServiceFutureStub extends io.grpc.stub.AbstractStub<CarParkServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.sample.park.ParkResponse> parkVehicle(
        org.sample.park.ParkRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PARK_VEHICLE:
          serviceImpl.parkVehicle((org.sample.park.ParkRequest) request,
              (io.grpc.stub.StreamObserver<org.sample.park.ParkResponse>) responseObserver);
          break;
        case METHODID_PARK_VEHICLE_MANY_TIMES:
          serviceImpl.parkVehicleManyTimes((org.sample.park.ParkRequest) request,
              (io.grpc.stub.StreamObserver<org.sample.park.ParkResponseManyTimes>) responseObserver);
          break;
        default:
  ...
  private static final class CarParkServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.sample.park.CarPark.getDescriptor();
    }
  }
